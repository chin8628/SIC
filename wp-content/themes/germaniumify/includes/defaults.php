...
if (!$installed) {
	...
	update_option(PADD_NAME_SPACE . '_ads_468060_1','<img alt="Advertisement" src="' . get_template_directory_uri() . '/images/advertisement-468x060.png" />');
	update_option(PADD_NAME_SPACE . '_ads_300250_1','<img alt="Advertisement" src="' . get_template_directory_uri() . '/images/advertisement-300x250.png" />');
	update_option(PADD_NAME_SPACE . '_ads_250250_1','<img alt="Advertisement" src="' . get_template_directory_uri() . '/images/advertisement-250x250.jpg" />');
	update_option(PADD_NAME_SPACE . '_ads_728090_1','<img alt="Advertisement" src="' . get_template_directory_uri() . '/images/advertisement-728x090.png" />');
}
