...
function padd_theme_widget_sponsors() {
	$ad = get_option(PADD_NAME_SPACE . '_ads_250250_1','');
 ...
 **/ 
function padd_theme_widget_popular_posts($limit=3,$range='all',$order_by='comment_count') {
	global $wpdb;
	...
	if ( !is_array($mostpopular) || empty($mostpopular) ) {
		...
		?>	
			<div class="popular-post">
				...
				<div class="meta">
					<p>
						<span class="category"><?php the_category(', ','',$post->ID); ?></span> <span class="no-display">|</span>  
