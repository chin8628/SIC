...
define('PADD_THEME_NAME','Germaniumify');
define('PADD_THEME_VERS','1.0');
define('PADD_THEME_SLUG','germaniumify');
define('PADD_NAME_SPACE','padd');
define('PADD_LIST_THUMB_W',580);
define('PADD_LIST_THUMB_H',280);
define('PADD_LIST_THUMB_S_W',50);
define('PADD_LIST_THUMB_S_H',50);
define('PADD_THEME_FWVER','2.6.5');
...
add_image_size(PADD_THEME_SLUG . '-thumbnail-small',PADD_LIST_THUMB_S_W,PADD_LIST_THUMB_S_H,true);
...
require PADD_FUNCT_PATH . 'administration' . DIRECTORY_SEPARATOR . 'users.php';
