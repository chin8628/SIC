...
<div class="box box-popular-posts">
	...
	<div class="interior">
		<?php 
			get_mostpopular('pages=0&stats_comments=1&range=all&limit=5&thumbnail_width=50&thumbnail_height=50&do_pattern=1&pattern_form={image}{title}{stats}');
		?>
	</div>
</div>
