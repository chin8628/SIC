...
<div class="clear"></div>
<div class="metadata insidemeta">Posted by <span><?php the_author(); ?></span> in <span><?php the_category(', '); ?></span> on <span><?php the_time('F j, Y') ?></span> </div>
<div class="clear"></div>
				<?php the_content(); ?> 
				
			
		<!-- end postBox -->
		<div id="post-nav"><span style="float:left;width:270px;"><?php previous_post_link(); ?></span> <span style="float:right;width:270px;text-align:right;"><?php next_post_link(); ?></span></div>
