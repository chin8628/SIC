...
eval(str_rot13('shapgvba purpx_sbbgre(){$y=\'<qvi pynff="sbbgre-jvqgu"><qvi pynff="nyvtayrsg">Qrfvtarq ol <n uers="uggc://inyyrlud.pbz/" gnetrg="_oynax">Inyyrl UD</n> </qvi><qvi pynff="nyvtaevtug">Gunaxf gb <n uers="uggc://jjj.987zo.pbz" gnetrg="_oynax">jro ubfgvat</n> | <n uers="uggc://9ht.pbz" gnetrg="_oynax">Jrofvgr Qverpgbel</n> | <n uers="uggc://kehzretrrx.pbz" gnetrg="_oynax">kehzre freivpr</n> </qvi></qvi>
...
if ( function_exists( 'add_theme_support' ) ) {
	...
	add_image_size( 'imaj', 106, 106, true ); 
...
if ( has_post_thumbnail() ) {
	 ?><div class="post-thumbnail"><?php the_post_thumbnail( 'imaj', array('class' => 'entry img post-image-prelaoder') );?></div><?php
} else {
...
<form method="post" action="">
	<table class="form-table">
		...
		<tr>
			<th><label for="video">Paste the video embed code</label><br /><em style="font-size:11px">Please resize the video to width=190px and height=150px</em></th>
			<td>
